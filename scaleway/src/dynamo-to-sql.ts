...
export async function createTenantSchema(tablePrefix: string): Promise<void> {
  ...
  const statements = [
    ...
    `CREATE TABLE IF NOT EXISTS ${schema}."downloads" ("applicationId" TEXT NOT NULL, "downloadId" TEXT NOT NULL, "customerId" TEXT, "versionId" TEXT, "fileId" TEXT, "clientIp" TEXT, "userAgent" TEXT, "downloadedAt" TEXT, "fileSize" BIGINT, "downloadDuration" BIGINT, "ttl" BIGINT, PRIMARY KEY ("applicationId", "downloadId"))`,
